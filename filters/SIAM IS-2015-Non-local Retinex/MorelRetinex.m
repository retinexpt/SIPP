% L2 Retinex test for "traditional" Retinex
%
...
% image setup
filename = 'gradient.png'; % test Image is from IPOL
scale = 'linear'; % linear or log image prescaling (gamma correction)

% Model parameters
p = 2; % L1-based retinex
lambda = 0.01; % pick a filter parameter / threshold
